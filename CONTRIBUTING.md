...
The canonical repository is the only development surface. The standalone
`workflow-skill-router-plugin` repository is generated by the authorized release
workflow; do not submit runtime changes or manually repair generated files or
tags there.
