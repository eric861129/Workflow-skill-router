...
These examples use the same public-safe skill names as the template download package.

## Complete Case Studies

Each case shows the full path from user intent to a focused skill set.
