...
| 套件 | 適合情境 | 下載 |
| --- | --- | --- |
| Blank Router | 想依照自己的 skills、triggers、exclusions 與 routing rules 建立自己的 router。 | [workflow-skill-router-blank.zip](downloads/workflow-skill-router-blank.zip) |
| Reference Template | 想先研究一份 public-safe 範例，再回頭改造 blank router 成自己的 workflow。 | [workflow-skill-router-template-clean.zip](downloads/workflow-skill-router-template-clean.zip) |
| Full source archive | 需要 per-skill README、source context，或想 audit Reference Template 來源。 | [workflow-skill-router-template.zip](downloads/workflow-skill-router-template.zip) |
