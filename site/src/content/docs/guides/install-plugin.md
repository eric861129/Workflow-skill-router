...
Use the immutable `v2.0.0-beta.3` snapshot for normal installations:
...
The bundled local R0 runtime in `v2.0.0-beta.3` supports Personal Routing Profile validation, installation, listing, and preview. From a contributor checkout, install the packaged personal example and preview it:
