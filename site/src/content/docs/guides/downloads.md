...
The `v2.0.1` Plugin and Skill-only packages both include the strict Personal and Workspace Routing Profile examples. Skill-only can read fixed local Profile paths only when the Host grants filesystem access.
...
Use the immutable `v2.0.1` GitHub Release assets instead of mutable `raw/main/downloads` files.

- [Plugin ZIP: `workflow-skill-router-plugin-v2.0.1.zip`](https://github.com/eric861129/Workflow-skill-router/releases/download/v2.0.1/workflow-skill-router-plugin-v2.0.1.zip)
- [Skill-only ZIP: `workflow-skill-router-skill-v2.0.1.zip`](https://github.com/eric861129/Workflow-skill-router/releases/download/v2.0.1/workflow-skill-router-skill-v2.0.1.zip)
