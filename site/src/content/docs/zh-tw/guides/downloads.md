...
<div class="wsr-download-picker" aria-label="V2 安裝模式比較">
  ...
  <article class="wsr-download-card">
    ...
    <dl class="wsr-download-specs">
      ...
      <div><dt>包含</dt><dd><code>SKILL.md</code>、<code>references/evaluation-boundary.md</code>、<code>references/goal-protocol.md</code> 與 <code>references/routing-protocol.md</code></dd></div>
...
`v2.0.0-beta.1` GitHub prerelease 已發布。以下不可變 release assets 比可變動的 `raw/main/downloads` 檔案更適合下載、檢查與安裝。
