...
<img src="/Workflow-skill-router/assets/workflow_skill_rout-GIF.gif" alt="高畫質 Workflow Skill Router demo，展示 router 概念與公開發布流程" width="1280" height="720" loading="lazy" decoding="async" />

輕量 fallback：[60 秒 demo GIF](/Workflow-skill-router/assets/workflow-skill-router-60s-demo.gif)。
