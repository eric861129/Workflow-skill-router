...
目前 checkout 已實作 `conditional-local` source work，但它 **not included in published beta.3**，也不代表 beta.5 已發布。Product metadata 會維持在已準備但尚未發布的 beta.4 candidate，直到後續 release task。
