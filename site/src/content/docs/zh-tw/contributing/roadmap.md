...
## Beta — integration 與 reviewed behavior

- 發布不可變的 `v2.0.0-beta.1` marketplace snapshot
- 在明確 quota authorization 下完成修正後的 36-attempt Behavior smoke
- 審查 paired results，只發布有 attestation 且已去識別化的 evidence
- 在 Windows、macOS、Linux 驗證 release archive 的 Plugin 與純 SKILL 安裝
