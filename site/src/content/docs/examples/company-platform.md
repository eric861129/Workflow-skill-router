...
These routes use anonymized placeholder skill names so teams can map the pattern to their own platform-specific skills.
...
This example keeps platform-specific judgment close to the task while still using generic engineering skills only when they add a distinct job.
...
- [Open `references/sample-routes.md`](https://github.com/eric861129/Workflow-skill-router/blob/main/examples/company-platform-sanitized/references/sample-routes.md)
