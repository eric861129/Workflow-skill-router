---
title: Source Map
description: Direct links to the repository folders and files behind the site.
---

Use these links when you want to inspect the actual repository source instead of only reading the documentation pages.

## Core package

- [Repository root](https://github.com/eric861129/Workflow-skill-router)
- [Starter router skill](https://github.com/eric861129/Workflow-skill-router/tree/main/starter/workflow-skill-router)
- [Starter `SKILL.md`](https://github.com/eric861129/Workflow-skill-router/blob/main/starter/workflow-skill-router/SKILL.md)
- [Starter skill tree](https://github.com/eric861129/Workflow-skill-router/blob/main/starter/workflow-skill-router/references/skill-tree.md)
- [Starter routing rules](https://github.com/eric861129/Workflow-skill-router/blob/main/starter/workflow-skill-router/references/routing-rules.md)
...
- [Blank SKILL zip](https://github.com/eric861129/Workflow-skill-router/raw/main/downloads/workflow-skill-router-blank.zip)
- [Reference Template zip](https://github.com/eric861129/Workflow-skill-router/raw/main/downloads/workflow-skill-router-template-clean.zip)
- [Full source archive zip](https://github.com/eric861129/Workflow-skill-router/raw/main/downloads/workflow-skill-router-template.zip)
